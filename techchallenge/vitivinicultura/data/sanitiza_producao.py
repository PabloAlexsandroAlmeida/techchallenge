...
df_clean.to_csv('Producao_sanitizado.csv', index=False)

print("Processamento concluído! O arquivo sanitizado foi salvo como 'Producao_sanitizado.csv'.")
...
output_json_path = 'Producao_sanitizado.json'
